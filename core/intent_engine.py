...
INTENT_KEYWORDS: Dict[str, List[str]] = {
    ...
    "edit_video": [
        ...
        "editame el video", "editame el vídeo", "editame un video", "editar video",
        "hazme un edit", "hazme un tiktok", "haz un edit",
        "trim video", "edit video", "cut video",
    ],
    "cambiar_formato": [
        "cambia el formato", "cambiale el formato", "cambiale el aspecto",
        "ponlo en formato", "ponlo en 4:3", "ponlo en 16:9", "ponlo en 9:16",
        "cambia la resolucion", "cambiale la resolucion", "cambia resolucion",
        "cambiar resolucion",
        "aspect ratio", "formato 4:3", "formato 16:9", "formato 9:16",
        "convierte a 4:3", "convierte a 16:9", "convierte a 9:16",
        "pasalo a 4:3", "pasalo a 16:9", "pasalo a 9:16",
        "hazlo 4:3", "hazlo 16:9", "hazlo cuadrado", "hazlo vertical",
        "ponlo cuadrado", "ponlo vertical",
        "cambiar formato", "cambiar aspecto",
    ],
    "edit_image": [
    ...
    "greeting": [
        ...
        "ey mano", "oe mano", "parcero", "parce", "brother", "bro",
        "ñero", "ñera", "loco", "tío", "tia", "amigo", "amiga",
        "ps", "pss", "pues", "a ver", "ver", "mira", "fíjate",
        "qué más", "que mas", "qué más pues",
        "cómo te va", "como te va", "cómo vamos", "como vamos",
        "todo bien", "cómo vas",
        "hi there", "hey there", "yo", "aló",
    ],
    "help": [
...
TOOL_ALIASES: Dict[str, str] = {
    # ===== MAPA INTENT -> TOOL =====
    # Puente crítico intent→tool: evita que el LLM alucine tool names
    "edit_video": "advanced_video_editor",
    "editar_video": "advanced_video_editor",
    "video_editor": "advanced_video_editor",
    "cambiar_formato": "advanced_video_editor",
    "change_format": "advanced_video_editor",
    "recortar_video": "advanced_video_editor",
    "cortar_video": "advanced_video_editor",
    "unir_videos": "advanced_video_editor",
    "fusionar_videos": "advanced_video_editor",
    "editar_audio": "advanced_video_editor",
    "editar_imagen": "photo_editor_tools",
    "edit_image": "photo_editor_tools",
    "photo_editor": "photo_editor_tools",
    "foto_editor": "photo_editor_tools",
    "imagen_editor": "photo_editor_tools",
    "retocar_foto": "photo_editor_tools",
    "edit_photo": "photo_editor_tools",
    "editar_documento": "write_file",
    "edit_document": "write_file",
    "edit_file": "write_file",
    "modificar_archivo": "write_file",
    "organizar_archivos": "execute_cmd",
    "organizar_carpeta": "execute_cmd",
    "convertir_archivo": "execute_cmd",
    "convert_file": "execute_cmd",
    "automatizar": "execute_cmd",
    "automatizar_tarea": "execute_cmd",
    "programar_tarea": "scheduler_add_task",
    "scheduler_add": "scheduler_add_task",
    "add_task": "scheduler_add_task",
    "send_whatsapp": "send_whatsapp_message",
    "enviar_wspe": "send_whatsapp_message",
    "enviar_whatsapp": "send_whatsapp_message",
    "mandar_whatsapp": "send_whatsapp_message",
    "mandar_wspe": "send_whatsapp_message",
    "mensaje_whatsapp": "send_whatsapp_message",
