...
TOOL_SEEDS: Dict[str, List[str]] = {
    ...
    "find_file": ["find_file", "buscar_archivo", "busca_archivo", "encontrar_archivo", "search_file", "search_files", "file_search", "locate_file", "buscar_app", "buscar_aplicacion", "buscar_programa", "buscar_carpeta", "find_folder", "encuentra_archivo"],
    "git_deploy": ["git_deploy", "desplegar_git", "deploy_github", "subir_cambios", "git_push_safe", "desplegar_repo", "push_github", "subir_a_github", "deploy_repo", "desplegar_cambios"],
    ...
    "generate_vyrex_video": ["generate_vyrex_video", "video_cinematico", "cinematic_video", "video_ia_pro", "video_premium"],
    "vyrex_generate_image": ["vyrex_generate_image", "image_studio", "imagen_vyrex", "vyrex_image", "generar_imagen_vyrex"],
    "vyrex_generate_video_api": ["vyrex_generate_video_api", "vyrex", "video_vyrex_api"],
    "vyrex_generate_voice": ["vyrex_generate_voice", "voz_vyrex", "tts_vyrex", "clonar_voz_vyrex"],
    "vyrex_create_story_video": ["vyrex_create_story_video", "crear_video_profesional", "video_por_escenas", "video_multiescena", "story_video", "video_completo"],
    "vyrex_publish_youtube": ["vyrex_publish_youtube", "publicar_youtube", "subir_youtube", "upload_youtube"],
    "vyrex_publish_facebook": ["vyrex_publish_facebook", "publicar_facebook", "subir_facebook"],
    "analyze_video_style": ["analyze_video_style", "analizar_video", "copiar_estilo", "ver_tiktok", "ver_video", "analizar_estilo"],
    "vyrex_text_to_clip": ["vyrex_text_to_clip", "texto_a_video", "texto_a_clip", "text_to_video", "clip_con_audio"],
    "vyrex_animate_image": ["vyrex_animate_image", "animar_imagen", "animate_image", "dar_vida_imagen", "imagen_a_video"],
    "edit_file": ["edit_file", "editar_archivo", "edit", "patch_file", "arreglar_archivo", "modificar_archivo"],
    "run_python_code": ["run_python_code", "python_inline", "correr_python", "ejecutar_python", "python_code", "script_python"],
    "ssh_exec": ["ssh_exec", "ssh", "comando_remoto", "servidor_remoto", "vps_exec", "remote_exec"],
    "shell_batch": ["shell_batch", "comandos_paralelo", "varios_comandos", "batch_shell", "multi_comando", "correr_varios"],
    "run_background": ["run_background", "background", "en_segundo_plano", "lanzar_bg", "job_background"],
    "check_jobs": ["check_jobs", "ver_jobs", "estado_jobs", "listar_jobs", "revisar_tareas_bg"],
    "job_output": ["job_output", "salida_job", "ver_output", "resultado_job"],
    "kill_job": ["kill_job", "matar_job", "detener_job", "cancelar_job"],
    "ssh_read_file": ["ssh_read_file", "leer_archivo_remoto", "read_remote", "cat_remoto"],
    "ssh_write_file": ["ssh_write_file", "escribir_archivo_remoto", "write_remote", "subir_contenido"],
    "ssh_edit_file": ["ssh_edit_file", "editar_archivo_remoto", "edit_remote", "modificar_remoto"],
    "ssh_append_file": ["ssh_append_file", "append_remoto", "anadir_archivo_remoto"],
    "ssh_upload": ["ssh_upload", "subir_archivo", "upload_ssh", "sftp_put"],
    "diagnose_website": ["diagnose_website", "diagnosticar_web", "revisar_web", "check_saas", "diagnostico_saas", "monitorear_web"],
